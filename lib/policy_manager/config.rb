module PolicyManager
  class Config
    mattr_accessor :current_user_method, :is_admin_method, :can_ask_anonymization, :anonymize_method, :portability_path, :anonymize_path, :user_resource, :registery, :skip_portability_request_approval, :other_services,
